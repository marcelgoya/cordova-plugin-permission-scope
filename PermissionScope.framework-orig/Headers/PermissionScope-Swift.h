...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PermissionScope",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// returns:
/// Permission status for the requested type.
- (enum PermissionStatus)statusSpeech SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC15PermissionScope16SpeechPermission")
@interface SpeechPermission : NSObject <Permission>
@property (nonatomic, readonly) enum PermissionType type;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
